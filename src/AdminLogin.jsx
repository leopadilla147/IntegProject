                    ...
                    <Row className='d-flex justify-content-center align-items-center text-center h-100'>
                        ...
                        <Col>
                            <Col className='col-md-12 mb-4'>
                                <Button as={Link} to='./VPREAuth' variant='outline-primary' className='VPREbtn btn'>
                                    VPRE
                                </Button>
                            </Col>
                            <Col className='col-md-12 mb-4'>
                                <Button as={Link} to='./OfficeHeadLogin' variant='outline-primary' className='OfficeHeadbtn btn'>
                                    Office Head
                                </Button>
                            </Col>
